...
const outputPath = resolve(rootDir, 'output', 'cv-mehul-chovatiya-3rd-digital.html');
...
const replacements = {
  ...
  '{{LOCATION}}': 'Ahmedabad, Gujarat, India (On-site / Gota)',
  '{{SECTION_SUMMARY}}': 'Professional Summary',
  '{{SUMMARY_TEXT}}': 'Node.js Developer with 2+ years of production experience building scalable backends, real-time systems, and database architectures in Node.js. Eager to bring proven backend optimization and serverless automation skills to the on-site Node.js Developer role at 3rd Digital in Ahmedabad. Hands-on with MySQL, PostgreSQL, MongoDB, Redis, and cloud integrations. Track record of solving hard production problems: reduced search API query latency from 10s to 700ms–1.5s across 78K+ records and migrated legacy systems with zero data loss. Available to join immediately.',
  '{{SECTION_COMPETENCIES}}': 'Core Competencies',
  '{{COMPETENCIES}}': `
      <span class="competency-tag">Node.js Development</span>
      <span class="competency-tag">REST API Architecture</span>
      <span class="competency-tag">Database Management (MySQL, MongoDB)</span>
      <span class="competency-tag">Redis Caching & Job Queues</span>
      ...
      <span class="competency-tag">Auth & JWT Middleware</span>
  `,
